...
const captions = [
    ...
    <p>It's only a five minutes read. I've tried to keep it short and concise. You're not going to sit there scrolling forever.</p>`,
    },
    {
    target: 'languages',
    insertionDiv: 'backgroundRight',
    ...
    I actively&nbsp;learned how to craft and launch full-stack web applications. 
    ...
    insertionDiv: 'backgroundRight',
    attrToInsert: 
    `<p>Collaborating with a team of front-end developers on the construction of a web portal for an AI and LLM project. 
    The project is being developed using React, Typescript, and Tailwind. We are adhering to an AGILE approach with a SCRUM team collaboration framework 
    and a GitHub Project task-board system. During intervals between sprints, I engage with the Digital Marketing team, contributing
    ...
    attrToInsert:
    `<p>
    My initial exposure to Shopify marked my entrance into the world of eCommerce. Overseeing the management of two Shopify stores, I delved into 
    the intricacies of the Liquid templating language, crafting themes, and tailoring the storefronts' visual identity. Our extensive online 
    presence spanned multiple platforms, including Amazon, eBay, EKM, Kaufland, Mirakle ecosystem, Cdiscount, and others.</p>
    <p>My responsibilities were diverse and encompassed catalog maintenance, market research, sourcing new products for inclusion, price optimization 
    to ensure competitiveness, comprehensive product analysis and sales assessment. This experience was an invaluable journey that provided 
    ...
    adaptability. From high-pressure scenarios in remote islands to corporate environments within bustling metropolises, 
    I've successfully navigated both extremes of work settings. Check my Linkedin profile (link follows) for details.`,
    },
    {
    ...
    confidence in meeting the job requirements and performing up to the expected standards. I refrain from mass applications for various reasons. 
    ...
    <p>LinkedIn: <a style="text-align: left; font-size: 36px;" href="https://www.linkedin.com/in/babak-bigdeli-3b999055"; target="_blank">https://www.linkedin.com/in/babak-bigdeli-3b999055</a></p>
